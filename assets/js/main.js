...
function navHighlighter() {
  ...
  sections.forEach((current) => {
    ...
    /*  if our current scroll position enters the space where current on screen is, add .active class to correspanding navigation link, else remove it - To know which link needs an active class, we use sectionId variable we are getting while looping through */
